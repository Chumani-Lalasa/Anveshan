...
function Dashboard() {
  ...
  const reports = [
    {
      id: 1,
      name: "Blood Report Jan 2024",
      date: "2024-01-15",
      status: "Analyzed",
    },
    {
      id: 2,
      name: "Blood Report Feb 2024",
      date: "2024-02-18",
      status: "Pending",
    },
    {
      id: 3,
      name: "Blood Report Mar 2024",
      date: "2024-03-22",
      status: "Analyzed",
    },
  ];
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Upload and analyze your latest blood report.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white shadow-md rounded-md p-6 flex items-center">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Track trends in your health parameters.
            </p>
          </div>
        </div>
